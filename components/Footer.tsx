                    ...
                    <section className="pt-2 pb-5 text-true-gray-400" dark="text-true-gray-500">
                        <div className="flex justify-between w-full pb-2 my-2 text-xs border-b border-footer items-end" dark="border-true-gray-700">
                            <div className="flex flex-col gap-2">
                                ...
                                <p className="group">Design & Build with <span className="group-hover:text-red-400 transition-colors duration-500 ease-in-out">❤</span> by <a className="text-true-gray-600 hover:underline" href="https://github.com/MengXi2021" target="_blank" rel="noopener noreferrer" dark="text-true-gray-400">MengXi</a></p>
                            </div>
                            <p className="flex flex-col items-end">
                                <a className="hover:underline" href="https://old.mengxiblog.top" target="_blank" rel="noopener noreferrer">Old Blog</a>
                            </p>
                        </div>
                        ...
                        <p className="space-x-1 md:space-x-2 text-[10px] mt-2 text-true-gray-300">
                                    <span><a className="hover:underline hover:text-true-gray-400" dark="text-true-gray-700 hover:text-true-gray-400" href="http://beian.miit.gov.cn/" rel="noopener noreferrer" target="_blank">浙ICP备 2021030172 号</a></span>
                                    <span><a className="hover:underline hover:text-true-gray-400" dark="text-true-gray-700 hover:text-true-gray-400" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=32011202000528" rel="noopener noreferrer" target="_blank">浙公网安备 33010202002095 号</a></span>
                                </p>
                    </section>
                </div>
            </footer>
